<div class="header" style="margin-top:0 px;font-size:60%;">სმკმ: მეოთხე შეხვედრა</div>

სოციალურ მეცნიერებათა კვლევის მეთოდები
========================================================
author: დავით სიჭინავა
date: 11 აპრილი, 2019 წ.
autosize: true
transition: none
css: css/style.css
...
დავალება:
========================================================
* წაიკითხეთ [შემდეგი ნაშრომი](http://caucasusbarometer.org/downloads/NALAG_report.pdf)
...
* დავალება ატვირთეთ 17 აპრილის 23:59-მდე, [ამ ბმულზე](https://www.dropbox.com/request/FDCxORi0tFU8mDf1TQRP)
